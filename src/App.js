    ...
    createUserWithEmailAndPassword(auth, signUpData.email, signUpData.password)
      .then((userCredential) => {
        ...
        addDoc(collectionRef, {
          ...
          .catch((e) => {
            alert('Error adding user to Firestore: ' + e.message);
          });
      })
      .catch((e) => {
              ...
              <div className="card-body text-center">
                ...
                <div className='mailDiv d-flex flex-column align-items-center'>
                  <input
                    ...
                    name="email"
                    type="email"
                    className="inp form-control mb-2"
                    onChange={event => handleSignUpInputs(event)}
                  />
                  <input
            ...
            <div className="card rounded shadow bg-light">
              <div className="card-body text-center">
                ...
                <div className="auth-buttons mb-3">
                  <button className="button btn btn-dark me-2" onClick={addDataGoogle}>
                    <FcGoogle size={30} />
                  </button>
                  <button className="button btn btn-dark" onClick={addDataGithub}>
                    <FaGithub size={30} />
                  </button>
                </div>
          ...
          <div className="col-md-4 mb-4">
            <div className="card rounded shadow bg-light">
              <div className="card-body text-center">
                ...
                <button className="button btn btn-dark mb-4" onClick={fetchData}>
                  Display Users
                </button>
                {showUsers && (
